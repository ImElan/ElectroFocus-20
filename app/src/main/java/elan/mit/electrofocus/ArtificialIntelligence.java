...
public class ArtificialIntelligence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference mArtificialIntelligence = FirebaseDatabase.getInstance().getReference().child("WorkShops").child("ArtificialIntelligence").child("General");
        mArtificialIntelligence.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        RegisterNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Uri uri = Uri.parse("https://www.payumoney.com/events/#/buyTickets/efocus20_ai");
