...
public class RadioFrequencyIn5G extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_radio_frequency_in5_g);
        Toolbar mToolBar = findViewById(R.id.toolbar);
        setSupportActionBar(mToolBar);
        getSupportActionBar().setTitle("RF In 5G Application");
        ...
        DatabaseReference mRadioFrequencyIn5G = FirebaseDatabase.getInstance().getReference().child("WorkShops").child("RadioFrequencyIn5G").child("General");
        mRadioFrequencyIn5G.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        RegisterNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Uri uri = Uri.parse("https://www.payumoney.com/events/#/buyTickets/efocus20_rf5g");
