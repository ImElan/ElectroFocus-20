...
public class QualcommWifi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qualcomm_wifi);

        Toolbar mToolBar = findViewById(R.id.toolbar);
        setSupportActionBar(mToolBar);
        getSupportActionBar().setTitle("Qualcomm - Evolution Of WI-FI");
        ...
        DatabaseReference mCryptoGraphy = FirebaseDatabase.getInstance().getReference().child("WorkShops").child("Qualcomm").child("General");
        mCryptoGraphy.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        RegisterNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Uri uri = Uri.parse("https://www.payumoney.com/events/#/buyTickets/efocus20_qualcomm");
