...
public class CryptoGraphy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_crypto_graphy);

        Toolbar mToolBar = findViewById(R.id.toolbar);
        setSupportActionBar(mToolBar);
        getSupportActionBar().setTitle("CryptoGraphy Using CrypTool");
        ...
        DatabaseReference mCryptoGraphy = FirebaseDatabase.getInstance().getReference().child("WorkShops").child("CryptoGraphy").child("General");
        ...
        RegisterNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Uri uri = Uri.parse("https://www.payumoney.com/events/#/buyTickets/efocus20_crypt");
