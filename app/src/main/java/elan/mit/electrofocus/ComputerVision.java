...
public class ComputerVision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Open CV Computer Vision");
        ...
        DatabaseReference mComputerVision = FirebaseDatabase.getInstance().getReference().child("WorkShops").child("ComputerVision").child("General");
        mComputerVision.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        RegisterNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Uri uri = Uri.parse("https://www.payumoney.com/events/#/buyTickets/efocus20_vision");
