...
public class EvolutionOf5G extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_evolution_of5_g);

        Toolbar mToolBar = findViewById(R.id.toolbar);
        setSupportActionBar(mToolBar);
        getSupportActionBar().setTitle("Evolution Of 5G By BSNL");
        ...
        DatabaseReference mEvolutionOf5G = FirebaseDatabase.getInstance().getReference().child("WorkShops").child("EvolutionOf5G").child("General");
        mEvolutionOf5G.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        RegisterNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Uri uri = Uri.parse("https://www.payumoney.com/events/#/buyTickets/efocus20_bsnl");
