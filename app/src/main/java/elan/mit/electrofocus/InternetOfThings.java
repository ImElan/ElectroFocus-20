...
public class InternetOfThings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference mInternetOfThings = FirebaseDatabase.getInstance().getReference().child("WorkShops").child("InternetOfThings").child("General");
        mInternetOfThings.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        RegisterNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Uri uri = Uri.parse("https://www.payumoney.com/events/#/buyTickets/efocus20_iot");
